    ...
    >
      <nav className="mx-auto flex max-w-6xl items-center justify-between px-4 py-3">
        <a href="#hero" className="flex items-center gap-3">
          <img src="/images/leather-wood-logo.png" alt="Leather & Wood Car Detailing logo" className="h-9 w-auto" />
        ...
        <div className="flex items-center gap-3">
          ...
          <a href="#contact">
            <Button className="glow bg-primary text-primary-foreground hover:bg-[color-mix(in_oklch,var(--primary) 85%,black)]">
              Book Now
            </Button>
          </a>
        </div>
